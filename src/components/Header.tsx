...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute w-full bg-surface-light/95 backdrop-blur-xl border-b border-white/5 transition-all duration-300 ${
          isOpen
      ...
      >
        <div className="px-4 py-6 space-y-2">
          ...
          <a
            href="#download"
            onClick={() => setIsOpen(false)}
            className="block px-4 py-3 rounded-xl bg-gradient-to-r from-primary to-primary-light text-white font-bold text-center mt-4"
          >
            다운로드
          </a>
        </div>
