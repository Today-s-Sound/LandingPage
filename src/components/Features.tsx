...
import { Globe, Bell, Volume2, Eye, Filter, Zap, ArrowRight, CheckCircle } from 'lucide-react';

const features = [
    {
        icon: <Globe className="w-7 h-7" />,
        title: "웹페이지 자동 모니터링",
        description: "사용자가 지정한 웹페이지의 변경사항을 자동으로 감지하고 추적합니다.",
    ...
    },
    {
        ...
        title: "실시간 푸시 알림",
        description: "FCM을 이용해 변화가 감지되면 즉시 푸시 알림으로 알려드립니다.",
    ...
    },
    {
        ...
        title: "AI 요약 TTS 재생",
        description: "변경된 내용을 AI가 요약하고 음성으로 자동 안내해드립니다.",
    ...
    },
    {
        ...
        title: "고대비 접근성 UI",
        description: "KWCAG 가이드라인을 준수한 고대비 디자인으로 누구나 쉽게 사용할 수 있습니다.",
    ...
    },
    {
        ...
        title: "키워드 필터링",
        description: "관심 키워드를 설정하여 필요한 정보만 선별하여 받아볼 수 있습니다.",
...
export default function Features() {
    return (
        <section id="features" className="py-24 lg:py-32 feature-gradient relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-lg text-text-secondary max-w-2xl mx-auto">
                        시각적 제한에서 벗어나 웹 정보에 쉽고 빠르게 접근하세요.
                        오늘의 소리가 정보 독립성을 제공합니다.
                    </p>
                </div>
                ...
                <div className="mt-20 text-center">
                    <div className="inline-flex flex-wrap justify-center gap-6 text-text-secondary">
