                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 animate-fade-in">
                            ...
                            <span className="text-sm text-text-secondary">시각장애인을 위한 맞춤형 서비스</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12 animate-slide-up animate-delay-300">
                            <a href="#download" className="btn-primary flex items-center justify-center gap-3">
                                <Smartphone size={20} />
                                <span>앱 다운로드</span>
                            </a>
                            <a href="#features" className="btn-secondary flex items-center justify-center gap-3">
                                <Play size={20} />
                                <span>기능 알아보기</span>
                            </a>
                        </div>
                    ...
                    <div className="relative flex justify-center animate-fade-in animate-delay-300">
                                ...
                                <div className="flex-1 px-4 py-4 space-y-3 overflow-hidden">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span className="text-xs px-2 py-0.5 bg-red-500/20 text-red-400 rounded-full">긴급</span>
                                                </div>
                                                <p className="text-white text-sm font-medium truncate">새로운 공지사항이 등록되었습니다</p>
                                    ...
                                    <div className="glass rounded-2xl p-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-white text-sm font-medium truncate">페이지 업데이트 감지</p>
                                    ...
                                    <div className="glass rounded-2xl p-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-white text-sm font-medium truncate">키워드 알림</p>
                                                <p className="text-text-muted text-xs">관심 키워드 감지</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="absolute -top-4 -right-4 glass p-4 rounded-2xl animate-float animate-delay-200">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-white text-sm font-medium">TTS 재생 중</span>
                            </div>
                        </div>
                        ...
                        <div className="absolute -bottom-4 -left-4 glass p-4 rounded-2xl animate-float animate-delay-600">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-white text-sm font-bold">업데이트 발견!</div>
                                </div>
                            </div>
                        </div>
                    </div>
